    ...
    <div class="row justify-content-center">        
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <button type='button' onclick="window.location='{{ url('/selectCmp') }}'" class="text-sm text-gray-700 dark:text-gray-500 underline">Update a Company</a>
                </div>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <button type='button' onclick="window.location='{{ url('/select2deleteCmp') }}'" class="text-sm text-gray-700 dark:text-gray-500 underline">Delete a Company</a>
                </div>
                <div class="card-body">
                </div>
            </div>
